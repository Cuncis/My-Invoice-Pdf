...
import com.cuncis.myinvoice.data.ModelItems
import com.cuncis.myinvoice.util.toast
...
class MainActivity : AppCompatActivity() {
    ...
    var basfontLight: BaseFont =
            BaseFont.createFont("assets/app_font_light.ttf", "UTF-8", BaseFont.EMBEDDED)
    var appFontLight = Font(basfontLight, FONT_SIZE_SMALL)

    var basfontRegular: BaseFont =
            BaseFont.createFont("assets/app_font_regular.ttf", "UTF-8", BaseFont.EMBEDDED)
    var appFontRegular = Font(basfontRegular, FONT_SIZE_DEFAULT)


    var basfontSemiBold: BaseFont =
            BaseFont.createFont("assets/app_font_semi_bold.ttf", "UTF-8", BaseFont.EMBEDDED)
    var appFontSemiBold = Font(basfontSemiBold, 24f)


    var basfontBold: BaseFont =
            BaseFont.createFont("assets/app_font_bold.ttf", "UTF-8", BaseFont.EMBEDDED)
                    ...
                    .withPermissions(
                        ...
                        override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                            ...
                            if (report.areAllPermissionsGranted()) {
                                ...
                                val outPath =
                                        getExternalFilesDir(null).toString() + "/my_invoice1.pdf" //location where the pdf will store
                                Log.d("loc", outPath)
    ...
    private fun initInvoiceHeader(doc: Document) {
        val d = ContextCompat.getDrawable(this, R.drawable.gear)
